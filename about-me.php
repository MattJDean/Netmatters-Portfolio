        ...
        <div id="about" class="about__container">
            <section class="image">
                    ...
                    <div class="about__header">
                        <div class="about__header--img"><img src='../assets/img/about-me.png'></div>
                    </div>

                    <!--------------------------------------------------------------About Me Headline-->
                    <div class="about__headline">
                        <h1 class="headline__h1"><span>Great to meet you,</span></h1>
                        <h2 class="headline__h2"><span>I'm Matt.</span></h2>
                    </div>
            </section>
                    <!--------------------------------------------------------------About Me Text-->
            <section class="text">        
                    <div class="about__text">
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Asperiores, corporis!</p>
                    ...
                    <div class="about__cta">
                        <span><a href="/index.html#contact" class="contact-button">Contact Me</a></span>
                    </div>
            </section>
        </div>
