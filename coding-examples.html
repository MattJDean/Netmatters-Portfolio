...
<body>
        ...
        <div class="menu__container">
            ...
            <div class="menu__logo">
                <a href="index.html#hero"><span>MD</span></a>
            </div>
    ...
    <div class="examples__container">
        ...
        <h1><span>Code Examples</span></h1>

        <div class="examples">
           
            <div class="example__item">
                <h3 class="example__title"><span>Sticky Header</span></h3>

                <div class="example__image">
                    <img src='./assets/img/sticky-header-js-code.png' alt="Sticky Header Code" class="expandable-image" />
                </div>

                <h4 class="example__caption"><span>Sticky header for the Netmatters Homepage written in JavaScript</span></h4> 
                <div class="example__language"><i class="devicon-javascript-plain"></i></div> 

            <div class="example__item">
                <h3 class="example__title"><span>Sidebar Menu</span></h3>

                <div class="example__image">
                    <img src='./assets/img/sidebar-js-code.png' alt="Sidebar Menu Code" class="expandable-image" />
                </div>

                <h4 class="example__caption"><span>Sidebar menu for the Netmatters Homepage written in JavaScript</span></h4> 
                <div class="example__language"><i class="devicon-javascript-plain"></i></div> 
            </div>
